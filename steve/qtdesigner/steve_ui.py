...
#
# Created: Sat Jul 11 19:03:24 2015
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.foverlapLabel = QtGui.QLabel(self.tilesGroupBox)
        self.foverlapLabel.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.foverlapLabel.setObjectName(_fromUtf8("foverlapLabel"))
        self.horizontalLayout_11.addWidget(self.foverlapLabel)
        self.foverlapSpinBox = QtGui.QDoubleSpinBox(self.tilesGroupBox)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.MinimumExpanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.foverlapSpinBox.sizePolicy().hasHeightForWidth())
        self.foverlapSpinBox.setSizePolicy(sizePolicy)
        self.foverlapSpinBox.setMinimum(0.0)
        self.foverlapSpinBox.setMaximum(1.0)
        self.foverlapSpinBox.setSingleStep(0.01)
        self.foverlapSpinBox.setProperty("value", 0.05)
        self.foverlapSpinBox.setObjectName(_fromUtf8("foverlapSpinBox"))
        self.horizontalLayout_11.addWidget(self.foverlapSpinBox)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 252, 491))
        ...
        self.actionQuadView = QtGui.QAction(MainWindow)
        ...
        self.menuView.addAction(self.actionQuadView)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.foverlapLabel.setText(_translate("MainWindow", "Fraction of overlap:", None))
        ...
        self.actionQuadView.setText(_translate("MainWindow", "QuadView", None))
